...
EWAPI const Eo_Class *efl_future_class_get(void);
...
EOAPI extern const Eo_Event_Description _EFL_FUTURE_EVENT_FAILURE;
EOAPI extern const Eo_Event_Description _EFL_FUTURE_EVENT_SUCCESS;
EOAPI extern const Eo_Event_Description _EFL_FUTURE_EVENT_PROGRESS;
 ...
 * @ingroup Efl_Future
 */
EOAPI Efl_Future *efl_future_then(Eo *obj, Eo_Event_Cb success, Eo_Event_Cb failure, Eo_Event_Cb progress, const void *data);
