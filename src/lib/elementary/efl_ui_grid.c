...
static void
_item_place(Efl_Ui_Grid_Data *pd, Efl_Ui_Grid_Item *item)
{

}

static void
_relayout(Eo *obj Efl_Ui_Grid_Data *pd)
{
   Eina_List *l;
   Efl_Ui_Grid_Item_Data *id;
   ...
   if (!pd->nmax)
     {
         if (horiz) pd->nmax = (pd->geo.h / pd->item_size.h);
         else pd->nmax = (pd->geo.w / pd->item_size.w);
     }

   EINA_LIST_FOREACH(pd->items, l, id)
     {
        if (pd->need_update)
          {
             id->index = count;
             if (pd->dir == EFL_UI_DIR_VERTICAL)
               {
        ...
        ipos.x = pd->geo.x + id->pos.x;
        ipos.y = pd->geo.y + id->pos.y;
        efl_gfx_entity_position_set(id->obj, ipos);
...
static void
_reposition(Eo *obj Efl_Ui_Grid_Data *pd)
{
...
_efl_ui_grid_efl_canvas_group_group_calculate(Eo *obj, Efl_Ui_Grid_Data *pd)
{
   ...
   pos = efl_ui_scrollerable_pos_get();
   ...
   pd->pre_pos = efl_ui_scrollerable_pos_get();
...
_efl_ui_grid_efl_ui_scrollable_interactive_content_size_get(const Eo *obj EINA_UNUSED,
                                                            Efl_Ui_Grid_Data *pd)
{
...
_efl_ui_grid_efl_ui_scrollable_interactive_viewport_geometry_get(const Eo *obj EINA_UNUSED,
                                                                 Efl_Ui_Grid_Data *pd)
{
...
EOLIAN static void
_efl_ui_grid_efl_ui_scrollable_interactive_bounce_enabled_set(Eo *obj EINA_UNUSED,
                                                              Efl_Ui_Grid_Data *pd,
                                                              Eina_Bool horiz,
                                                              Eina_Bool vert)
{
...
EOLIAN static void
_efl_ui_grid_efl_ui_scrollable_interactive_bounce_enabled_get(const Eo *obj EINA_UNUSED,
                                                              Efl_Ui_Grid_Data *pd,
                                                              Eina_Bool *horiz,
                                                              Eina_Bool *vert)
{
...
EOLIAN static Eina_Bool
_efl_ui_grid_efl_ui_scrollable_interactive_scroll_hold_get(const Eo *obj EINA_UNUSED,
                                                           Efl_Ui_Grid_Data *pd)
{
...
EOLIAN static void
_efl_ui_grid_efl_ui_scrollable_interactive_scroll_hold_set(Eo *obj EINA_UNUSED,
                                                           Efl_Ui_Grid_Data *pd,
                                                           Eina_Bool hold)
{
...
EOLIAN static Eina_Bool
_efl_ui_grid_efl_ui_scrollable_interactive_scroll_freeze_get(const Eo *obj EINA_UNUSED,
                                                             Efl_Ui_Grid_Data *pd)
{
...
EOLIAN static void
_efl_ui_grid_efl_ui_scrollable_interactive_scroll_freeze_set(Eo *obj EINA_UNUSED,
                                                             Efl_Ui_Grid_Data *pd,
                                                             Eina_Bool freeze)
{
...
EOLIAN static void
_efl_ui_grid_efl_ui_scrollbar_bar_mode_set(Eo *obj EINA_UNUSED,
                                           Efl_Ui_Grid_Data *pd,
...
EOLIAN static void
_efl_ui_grid_efl_ui_scrollbar_bar_mode_get(const Eo *obj EINA_UNUSED,
                                           Efl_Ui_Grid_Data *pd,
                                           Efl_Ui_Scrollbar_Mode *hmode,
                                           Efl_Ui_Scrollbar_Mode *vmode)
{
...
EOLIAN static void
_efl_ui_grid_efl_ui_scrollable_interactive_scroll(Eo *obj EINA_UNUSED,
                                                  Efl_Ui_Grid_Data *pd,
                                                  Eina_Rect rc,
                                                  Eina_Bool animation)
{
...
EOLIAN static void
efl_ui_grid_table_size_set(Eo *obj, Efl_Ui_Grid_Data *pd, int col, int row)
{
   pd->table.row = row;
   pd->table.col = col;
}
...
EOLIAN static void
efl_ui_grid_table_size_get(Eo *obj, Efl_Ui_Grid_Data *pd, int *col, int *row)
{
   *row = pd->table.row;
   *col = pd->table.col;
}
