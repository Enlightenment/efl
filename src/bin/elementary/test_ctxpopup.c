...
{
   // FIXME: No legacy API to check if item is selected?
   //printf("Item selected status: %d\n", elm_item_interface_selected_get(event_info));

   printf("ctxpopup item selected: %s\n",
         elm_object_item_text_get(elm_menu_selected_item_get(obj)));
