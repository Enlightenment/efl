                            ...
                            Efl_Ui_Pagescroller_Data *pd)
{
   ...
   EINA_LIST_FOREACH(pd->content_list, l, subobj)
     {
        efl_gfx_size_set(subobj, EINA_SIZE2D(pd->w, pd->h));
...
_efl_ui_pagescroller_efl_ui_direction_direction_get(Eo *obj,
                                                   Efl_Ui_Pagescroller_Data *sd)
{
   return sd->dir;
}
...
EOLIAN static void
_efl_ui_pagescroller_efl_ui_direction_direction_set(Eo *obj,
                                                    Efl_Ui_Pagescroller_Data *sd,
                                                    Efl_Ui_Dir dir)
{
