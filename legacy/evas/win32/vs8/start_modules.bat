...
set ReleaseOutputDirectory=%SolutionDirectory%\out\modules
set DebugLibraryDirectory=%SolutionDirectory%\out\modules
set ReleaseLibraryDirectory=%SolutionDirectory%\out\modules
set TemporaryDirectory=%SolutionDirectory%\temp

set LIB=%DebugLibraryDirectory%\..;%DebugLibraryDirectory%;%ReleaseLibraryDirectory%;%LIB%
