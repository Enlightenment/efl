...
static const char MENU_SMART_NAME[] = "elm_menu";
...
#define ELM_MENU_CHECK(obj)                                             \
  if (!obj || !elm_widget_type_check((obj), MENU_SMART_NAME, __func__)) \
    return
...
EVAS_SMART_SUBCLASS_NEW
  (MENU_SMART_NAME, _elm_menu, Elm_Widget_Smart_Class, Elm_Widget_Smart_Class,
...
_elm_menu_smart_set_user(Elm_Widget_Smart_Class *sc)
{
   ...
   sc->base.del = _elm_menu_smart_del;
   sc->base.show = _elm_menu_smart_show;
