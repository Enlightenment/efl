...
EOLIAN static Elm_Object_Item*
_elm_toolbar_elm_menu_interface_first_item_get(Eo *obj EINA_UNUSED, Elm_Toolbar_Data *sd)
{
...
EOLIAN static Elm_Object_Item*
_elm_toolbar_elm_menu_interface_last_item_get(Eo *obj EINA_UNUSED, Elm_Toolbar_Data *sd)
{
   if (!sd->items) return NULL;
...
_elm_toolbar_elm_menu_interface_items_get(Eo *obj EINA_UNUSED, Elm_Toolbar_Data *sd)
{
   return eina_inlist_iterator_new(sd->items);
}

EOLIAN static Elm_Object_Item *
_elm_toolbar_item_elm_item_interface_next_get(Eo *eo_item EINA_UNUSED, Elm_Toolbar_Item_Data *it)
{
...
EOLIAN static Elm_Object_Item *
_elm_toolbar_item_elm_item_interface_prev_get(Eo *eo_item EINA_UNUSED, Elm_Toolbar_Item_Data *it)
{
   ELM_TOOLBAR_ITEM_CHECK_OR_RETURN(it, NULL);
...
EOLIAN static void
_elm_toolbar_item_elm_item_interface_selected_set(Eo *eo_item EINA_UNUSED, Elm_Toolbar_Item_Data *item, Eina_Bool selected)
{
...
EOLIAN static Eina_Bool
_elm_toolbar_item_elm_item_interface_selected_get(Eo *eo_item EINA_UNUSED, Elm_Toolbar_Item_Data *item)
{
   return item->selected;
}

EOLIAN static Elm_Object_Item*
_elm_toolbar_elm_menu_interface_selected_item_get(Eo *obj EINA_UNUSED, Elm_Toolbar_Data *sd)
{
...
_elm_toolbar_item_efl_access_state_set_get(Eo *eo_it, Elm_Toolbar_Item_Data *item EINA_UNUSED)
{
   ...
   sel = elm_item_interface_selected_get(eo_it);
