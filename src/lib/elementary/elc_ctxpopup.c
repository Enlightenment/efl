...
_elm_ctxpopup_elm_menu_interface_items_get(Eo *obj EINA_UNUSED, Elm_Ctxpopup_Data *sd)
{
   return eina_list_iterator_new(sd->items);
}

EOLIAN static Elm_Object_Item*
_elm_ctxpopup_elm_menu_interface_first_item_get(Eo *obj EINA_UNUSED, Elm_Ctxpopup_Data *sd)
{
...
EOLIAN static Elm_Object_Item*
_elm_ctxpopup_elm_menu_interface_last_item_get(Eo *obj EINA_UNUSED, Elm_Ctxpopup_Data *sd)
{
   if (!sd->items) return NULL;
...
EOLIAN static Elm_Object_Item*
_elm_ctxpopup_elm_menu_interface_selected_item_get(Eo *obj EINA_UNUSED, Elm_Ctxpopup_Data *sd)
{
   Eina_List *l;
...
EOLIAN static Elm_Object_Item *
_elm_ctxpopup_item_elm_item_interface_prev_get(Eo *eo_item EINA_UNUSED, Elm_Ctxpopup_Item_Data *item)
{
   Eina_List *l;
...
EOLIAN static Elm_Object_Item *
_elm_ctxpopup_item_elm_item_interface_next_get(Eo *eo_item EINA_UNUSED, Elm_Ctxpopup_Item_Data *item)
{
   Eina_List *l;
...
EOLIAN static void
_elm_ctxpopup_item_elm_item_interface_selected_set(Eo *eo_item EINA_UNUSED,
...
EOLIAN static Eina_Bool
_elm_ctxpopup_item_elm_item_interface_selected_get(Eo *eo_item EINA_UNUSED, Elm_Ctxpopup_Item_Data *item)
{
