 ...
 */
typedef struct _Evas_Object_Textblock             Efl2_Canvas_Text_Data;
/**
 * @internal
...
struct _Text_Item_Filter
{
   ...
   Efl2_Canvas_Text_Data            *textblock;
...
static void _evas_textblock_invalidate_all(Efl2_Canvas_Text_Data *o);
...
static const char *_textblock_format_node_from_style_tag(Efl2_Canvas_Text_Data *o, Evas_Object_Textblock_Node_Format *fnode, const char *format, size_t format_len);
#ifdef HAVE_HYPHEN
/* Hyphenation */
...
_layout_find_paragraph_by_y(Efl2_Canvas_Text_Data *o, Evas_Coord y)
{
...
static inline Evas_Object_Textblock_Paragraph *
_layout_find_paragraph_by_line_no(Efl2_Canvas_Text_Data *o, int line_no)
{
   Evas_Object_Textblock_Paragraph *start, *par;
   int i;
 ...
 */
static inline void
_layout_update_bidi_props(const Efl2_Canvas_Text_Data *o,
      Evas_Object_Textblock_Paragraph *par)
{
   if (par->text_node)
     {
...
_paragraph_clear(Evas_Public_Data *evas,
      Efl2_Canvas_Text_Data *o, Evas_Object_Protected_Data *obj,
      Evas_Object_Textblock_Paragraph *par)
{
   while (par->lines)
     {
...
_filter_program_find(Efl2_Canvas_Text_Data *o, const char *name)
{
...
_format_filter_program_get(Efl2_Canvas_Text_Data *o, Evas_Object_Textblock_Format *fmt)
{
...
static inline void
_layout_paragraph_render(Efl2_Canvas_Text_Data *o,
			 Evas_Object_Textblock_Paragraph *par)
{
   if (par->rendered)
      return;
 ...
 */
static Eina_Bool
_relayout_if_needed(const Evas_Object *eo_obj, Efl2_Canvas_Text_Data *o)
{
   ASYNC_BLOCK;
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
...
EOLIAN static Eo *
_efl2_canvas_text_efl_object_constructor(Eo *eo_obj, Efl2_Canvas_Text_Data *class_data EINA_UNUSED)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   Efl2_Canvas_Text_Data *o;
...
static void
_evas_textblock_update_format_nodes_from_style_tag(Efl2_Canvas_Text_Data *o)
{
   if (!o)
     {
        ERR("The given address Efl2_Canvas_Text_Data is NULL");
        return;
     }
...
static const char *
_textblock_format_node_from_style_tag(Efl2_Canvas_Text_Data *o, Evas_Object_Textblock_Node_Format *fnode, const char *format, size_t format_len)
{
   Eina_List *itr;
...
EOLIAN static void
_efl2_canvas_text_style_set(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, const char *key, const Efl2_Text_Attribute_Handle *attribute)
{
   // FIXME-implement
}
...
EOLIAN static void
_efl2_canvas_text_legacy_newline_set(Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o, Eina_Bool mode)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
...
_efl2_canvas_text_legacy_newline_get(const Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o)
{
...
static void
_evas_object_textblock_text_markup_set(Eo *eo_obj, Efl2_Canvas_Text_Data *o,
      const char *text)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   evas_object_async_block(obj);
...
EOLIAN static void
_efl_canvas_text_efl_text_markup_markup_set(Eo *eo_obj, Efl2_Canvas_Text_Data *o,
      const char *text)
{
   ASYNC_BLOCK;
...
static const char*
_evas_object_textblock_text_markup_get(const Eo *eo_obj, Efl2_Canvas_Text_Data *o)
{
   Evas_Object_Textblock_Node_Text *n;
   ...
   (((Efl2_Canvas_Text_Data *)o)->markup_text) = eina_stringshare_add(eina_strbuf_string_get(txt));
...
static Evas_Textblock_Obstacle *
_obstacle_find(Efl2_Canvas_Text_Data *o, Eo *eo_obs)
{
   Evas_Textblock_Obstacle *obs;
   Eina_List *i;
...
static void
_obstacles_free(Eo *eo_obj, Efl2_Canvas_Text_Data *o)
{
   Evas_Textblock_Obstacle *obs;
...
EOLIAN static Eina_Bool
_efl2_canvas_text_obstacle_add(Eo *eo_obj,
      Efl2_Canvas_Text_Data *o, Eo *eo_obs)
{
   Evas_Textblock_Obstacle *obs;
 ...
 */
static void
_evas_textblock_nodes_merge(Efl2_Canvas_Text_Data *o, Evas_Object_Textblock_Node_Text *to)
{
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_paragraph_first(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_paragraph_last(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_paragraph_next(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Evas_Textblock_Cursor *cur)
{
   ASYNC_BLOCK;
...
_efl_canvas_text_efl_text_cursor_cursor_paragraph_prev(Eo *obj EINA_UNUSED,
      Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_word_start(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur EINA_UNUSED)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_word_end(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur EINA_UNUSED)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_char_next(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_char_prev(Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_cluster_next(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_cluster_prev(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_paragraph_char_first(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_paragraph_char_last(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
   evas_textblock_cursor_paragraph_char_last(cur);
   efl_event_callback_legacy_call(eo_obj, EFL_CANVAS_TEXT_EVENT_CURSOR_CHANGED, NULL);
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_line_char_last(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_line_char_first(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
 ...
 */
static void
_evas_textblock_node_format_adjust_offset(Efl2_Canvas_Text_Data *o,
      Evas_Object_Textblock_Node_Text *tnode,
 ...
 */
static Eina_Bool
_evas_textblock_node_text_adjust_offsets_to_start(Efl2_Canvas_Text_Data *o,
 ...
 */
static void
_evas_textblock_node_text_remove(Efl2_Canvas_Text_Data *o, Evas_Object_Textblock_Node_Text *n)
{
...
EOLIAN static int
_efl_canvas_text_efl_text_cursor_cursor_position_get(const Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
   Evas_Object_Textblock_Node_Text *n;
   size_t npos = 0;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_position_set(Eo *cur_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur, int _pos)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_line_jump_by(Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur EINA_UNUSED, int by)
{
   ASYNC_BLOCK;
   int ln;
   Evas_Coord cx, cw;
...
EOLIAN static int
_efl_canvas_text_efl_text_cursor_cursor_compare(Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED,
...
EOLIAN static Eina_Bool
_efl_canvas_text_efl_text_cursor_cursor_equal(Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, const Efl_Text_Cursor_Cursor *cur, const Efl_Text_Cursor_Cursor *cur2)
{
   ASYNC_BLOCK;
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   evas_object_async_block(obj);
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_copy(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED,
 ...
 */
static void
_evas_textblock_cursors_set_node(Efl2_Canvas_Text_Data *o,
...
static inline void
_cursor_update_offset(Efl_Text_Cursor_Cursor *cur, Efl2_Canvas_Text_Data *o,
 ...
 */
static void
_evas_textblock_changed(Efl2_Canvas_Text_Data *o, Evas_Object *eo_obj)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   Eina_List *l;
...
static void
_evas_textblock_invalidate_all(Efl2_Canvas_Text_Data *o)
{
   Evas_Object_Textblock_Node_Text *n;
 ...
 */
static void
_evas_textblock_node_format_free(Efl2_Canvas_Text_Data *o,
      Evas_Object_Textblock_Node_Format *n)
{
   if (!n) return;
 ...
 */
static Evas_Object_Textblock_Node_Format *
_evas_textblock_node_format_new(Efl2_Canvas_Text_Data *o, const char *_format,
      Eina_Bool is_item)
{
   Evas_Object_Textblock_Node_Format *n;
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_char_delete(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur)
{
   ASYNC_BLOCK;
...
EOLIAN static void
_efl_canvas_text_range_delete(Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *pd EINA_UNUSED,
      Efl_Text_Cursor_Cursor *cur1, Evas_Textblock_Cursor *cur2)
{
   ...
   Evas_Object_Protected_Data *obj = efl_data_scope_get(cur1->obj, EFL_CANVAS_OBJECT_CLASS);
   evas_object_async_block(obj);
   Efl2_Canvas_Text_Data *o = efl_data_scope_get(cur1->obj, MY_CLASS);
...
_efl_canvas_text_efl_text_cursor_cursor_content_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED,
...
_efl_canvas_text_efl_text_markup_interactive_markup_range_get(const Eo *eo_obj,
      Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *start,
...
EOLIAN static Eina_Bool
_efl_canvas_text_efl_text_cursor_cursor_geometry_get(const Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, const Efl_Text_Cursor_Cursor *cur, Efl_Text_Cursor_Type ctype, Evas_Coord *cx, Evas_Coord *cy, Evas_Coord *cw, Evas_Coord *ch, Evas_Coord *cx2, Evas_Coord *cy2, Evas_Coord *cw2, Evas_Coord *ch2)
{
   ASYNC_BLOCK;
   if (!cur) return EINA_FALSE;
   Evas_Object_Protected_Data *obj = efl_data_scope_get(cur->obj, EFL_CANVAS_OBJECT_CLASS);
...
_efl2_canvas_text_visible_range_get(Eo *eo_obj EINA_UNUSED,
      Efl2_Canvas_Text_Data *pd EINA_UNUSED,
      Efl2_Text_Cursor *start, Efl2_Text_Cursor *end)
{
   Evas *eo_e;
   Evas_Coord cy, ch;
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_coord_set(Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur EINA_UNUSED,
...
EOLIAN static void
_efl_canvas_text_efl_text_cursor_cursor_cluster_coord_set(Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Cursor_Cursor *cur EINA_UNUSED,
      Evas_Coord x, Evas_Coord y)
{
   ASYNC_BLOCK;
...
_efl_canvas_text_range_simple_geometry_get(Eo *eo_obj EINA_UNUSED,
      Efl2_Canvas_Text_Data *o, const Efl_Text_Cursor_Cursor *cur1, const
...
EOLIAN static void
_efl2_canvas_text_size_formatted_get(const Eo *eo_obj, Efl2_Canvas_Text_Data *o, Evas_Coord *w, Evas_Coord *h)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   evas_object_async_block(obj);
   _relayout_if_needed(eo_obj, o);
...
EOLIAN static void
_efl2_canvas_text_size_native_get(const Eo *eo_obj, Efl2_Canvas_Text_Data *o, Evas_Coord *w, Evas_Coord *h)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   evas_object_async_block(obj);
   if (!o->native.valid)
...
EOLIAN static void
_efl2_canvas_text_style_insets_get(const Eo *eo_obj, Efl2_Canvas_Text_Data *o, Evas_Coord *l, Evas_Coord *r, Evas_Coord *t, Evas_Coord *b)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   evas_object_async_block(obj);
   _relayout_if_needed(eo_obj, o);
...
EOLIAN static void
_efl2_canvas_text_efl_object_dbg_info_get(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Dbg_Info *root)
{
...
EOLIAN static void
_efl2_canvas_text_efl_object_destructor(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
...
static void
_filter_output_cache_prune(Evas_Object_Protected_Data *obj, Efl2_Canvas_Text_Data *o)
{
                             ...
                             int x, int y, Eina_Bool do_async)
{
   ...
   Efl2_Canvas_Text_Data *o = type_private_data;
   ASYNC_BLOCK;
...
EOLIAN static void
_efl2_canvas_text_efl_canvas_filter_internal_filter_state_prepare(
      Eo *eo_obj, Efl2_Canvas_Text_Data *pd EINA_UNUSED, Efl_Canvas_Filter_State *state, void *data)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   Efl2_Canvas_Text_Data *o = efl_data_scope_get(eo_obj, EFL_CANVAS_TEXT_CLASS);
...
EOLIAN static Eina_Bool
_efl2_canvas_text_efl_canvas_filter_internal_filter_input_render(
      Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *pd EINA_UNUSED, void *filter,
...
EOLIAN static void
_efl2_canvas_text_efl_canvas_filter_internal_filter_dirty(
      Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *pd EINA_UNUSED)
{
   WRN("Filter marked as dirty. NOT IMPLEMENTED!");
}

EOLIAN static void
_efl2_canvas_text_efl_gfx_filter_filter_program_set(Eo *eo_obj, Efl2_Canvas_Text_Data *pd, const char *code, const char *name)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   Efl_Canvas_Text_Filter_Program *prg;
...
EOLIAN static void
_efl2_canvas_text_efl_gfx_filter_filter_program_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *pd EINA_UNUSED,
...
_filter_data_binding_find(Efl2_Canvas_Text_Data *pd, const char *name)
{
   Evas_Filter_Data_Binding *db;
...
EOLIAN static void
_efl2_canvas_text_efl_gfx_filter_filter_data_set(Eo *obj, Efl2_Canvas_Text_Data *pd, const char *name, const char *value, Eina_Bool execute)
{
   Efl_Canvas_Text_Filter_Program *prg;
   Evas_Filter_Data_Binding *db;
...
EOLIAN static void
_efl2_canvas_text_efl_gfx_filter_filter_data_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *pd, const char *name, const char **value, Eina_Bool *execute)
{
   Evas_Filter_Data_Binding *db;
...
EOLIAN static void
_efl2_canvas_text_efl_gfx_filter_filter_source_set(Eo *eo_obj, Efl2_Canvas_Text_Data *pd, const char *name, Efl_Gfx_Entity *eo_source)
{
...
_efl2_canvas_text_efl_gfx_filter_filter_source_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *pd, const char *name)
{
...
/*   o = (Efl2_Canvas_Text_Data *)(obj->object_data); */
...
EOLIAN static void
_efl2_canvas_text_efl_gfx_entity_scale_set(Evas_Object *eo_obj,
                                       Efl2_Canvas_Text_Data *o,
                                       double scale)
{
...
// FIXME this is called from somewhere. Figure this out.
void
_efl2_canvas_text_rehint(Evas_Object *eo_obj)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   Efl2_Canvas_Text_Data *o = efl_data_scope_get(eo_obj, MY_CLASS);
   Evas_Object_Textblock_Paragraph *par;
...
EOLIAN static void
_efl2_canvas_text_efl_canvas_object_paragraph_direction_set(Eo *eo_obj,
                                                           Efl2_Canvas_Text_Data *o,
...
_efl2_canvas_text_efl_canvas_object_paragraph_direction_get(const Eo *eo_obj EINA_UNUSED,
                                                           Efl2_Canvas_Text_Data *o)
{
...
static char *
_canvas_text_get_all(const Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
...
EOLIAN static const char *
_efl2_canvas_text_efl2_text_content_plain_text_get(const Eo *eo_obj, Efl2_Canvas_Text_Data *o)
{
   Evas_Object_Protected_Data *obj = efl_data_scope_get(eo_obj, EFL_CANVAS_OBJECT_CLASS);
   evas_object_async_block(obj);
...
static Eina_Bool
_textblock_annotation_set(Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o,
...
EOLIAN static const char *
_efl_canvas_text_efl_text_annotate_annotation_get(const Eo *eo_obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED,
...
_efl_canvas_text_efl_text_annotate_annotation_set(Eo *eo_obj,
      Efl2_Canvas_Text_Data *o, Efl_Text_Annotate_Annotation *annotation,
      const char *format)
{
   ASYNC_BLOCK;
   Efl_Text_Cursor_Cursor start, end;
...
static void
_evas_textblock_annotation_remove(Efl2_Canvas_Text_Data *o,
...
static void
_evas_textblock_annotations_clear(Efl2_Canvas_Text_Data *o)
{
   Efl_Text_Annotate_Annotation *an;
...
_textblock_annotation_insert(Eo *eo_obj, Efl2_Canvas_Text_Data *o,
      Efl_Text_Cursor_Cursor *start, Efl_Text_Cursor_Cursor *end,
      const char *format, Eina_Bool is_item)
{
...
_efl_canvas_text_efl_text_annotate_annotation_insert(Eo *eo_obj, Efl2_Canvas_Text_Data *o,
      Efl_Text_Cursor_Cursor *start, Efl_Text_Cursor_Cursor *end,
      const char *format)
{
   ASYNC_BLOCK;
...
EOLIAN static Eina_Iterator *
_efl_canvas_text_efl_text_annotate_range_annotations_get(const Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED,
...
EOLIAN static Eina_Bool
_efl_canvas_text_efl_text_annotate_item_geometry_get(Eo *eo_obj, Efl2_Canvas_Text_Data *o EINA_UNUSED,
...
static void
_canvas_text_format_changed(Eo *eo_obj, Efl2_Canvas_Text_Data *o)
{
   o->format_changed = EINA_TRUE;
   _evas_textblock_invalidate_all(o);
   _evas_textblock_changed(o, eo_obj);
...
static void
_efl_canvas_text_efl_text_font_font_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, const char *font EINA_UNUSED, int size EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_font_font_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, const char **font EINA_UNUSED, int *size EINA_UNUSED)
{
...
static void
_efl_canvas_text_efl_text_font_font_source_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, const char *font_source EINA_UNUSED)
{
...
static const char*
_efl_canvas_text_efl_text_font_font_source_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT_INFO(font_source);
}

static void
_efl_canvas_text_efl_text_font_font_fallbacks_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, const char *font_fallbacks EINA_UNUSED)
{
...
static const char*
_efl_canvas_text_efl_text_font_font_fallbacks_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT_INFO(font_fallbacks);
}

static void
_efl_canvas_text_efl_text_font_font_lang_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, const char *font_lang EINA_UNUSED)
{
...
static const char*
_efl_canvas_text_efl_text_font_font_lang_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT_INFO(font_lang);
}

static void
_efl_canvas_text_efl_text_font_font_weight_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Font_Weight font_weight EINA_UNUSED)
{
...
_efl_canvas_text_efl_text_font_font_weight_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT_INFO(font_weight);
}

static void
_efl_canvas_text_efl_text_font_font_slant_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Font_Slant font_slant EINA_UNUSED)
{
   ASYNC_BLOCK;
...
_efl_canvas_text_efl_text_font_font_slant_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT_INFO(font_slant);
}

static void
_efl_canvas_text_efl_text_font_font_width_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Font_Width font_width EINA_UNUSED)
{
   ASYNC_BLOCK;
...
_efl_canvas_text_efl_text_font_font_width_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT_INFO(font_width);
}

EOLIAN static void
_efl_canvas_text_efl_text_font_font_bitmap_scalable_set(Eo *obj, Efl2_Canvas_Text_Data *o, Efl_Text_Font_Bitmap_Scalable bitmap_scalable)
{
...
_efl_canvas_text_efl_text_font_font_bitmap_scalable_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o)
{
...
static void
_efl_canvas_text_efl_text_style_normal_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_style_normal_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
   _FMT_COLOR_RET(normal);
}

static void
_efl_canvas_text_efl_text_style_backing_type_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Style_Backing_Type type EINA_UNUSED)
{
   ASYNC_BLOCK;
...
_efl_canvas_text_efl_text_style_backing_type_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(backing);
}

static void
_efl_canvas_text_efl_text_style_backing_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_style_backing_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
...
static void
_efl_canvas_text_efl_text_style_underline_type_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Style_Underline_Type type EINA_UNUSED)
{
   ASYNC_BLOCK;
...
_efl_canvas_text_efl_text_style_underline_type_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(underline);
}

static void
_efl_canvas_text_efl_text_style_underline_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_style_underline_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
   _FMT_COLOR_RET(underline);
}

static void
_efl_canvas_text_efl_text_style_underline_height_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, double height EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static double
_efl_canvas_text_efl_text_style_underline_height_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(underline_height);
}

static void
_efl_canvas_text_efl_text_style_underline_dashed_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_style_underline_dashed_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
   _FMT_COLOR_RET(underline_dash);
}

static void
_efl_canvas_text_efl_text_style_underline_dashed_width_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, int width EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static int
_efl_canvas_text_efl_text_style_underline_dashed_width_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(underline_dash_width);
}

static void
_efl_canvas_text_efl_text_style_underline_dashed_gap_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, int gap EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static int
_efl_canvas_text_efl_text_style_underline_dashed_gap_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(underline_dash_width);
}

static void
_efl_canvas_text_efl_text_style_underline2_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_style_underline2_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
   _FMT_COLOR_RET(underline2);
}

static void
_efl_canvas_text_efl_text_style_strikethrough_type_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Style_Strikethrough_Type type EINA_UNUSED)
{
   ASYNC_BLOCK;
...
_efl_canvas_text_efl_text_style_strikethrough_type_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(strikethrough);
}

static void
_efl_canvas_text_efl_text_style_strikethrough_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_style_strikethrough_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
...
static void
_efl_canvas_text_efl_text_style_effect_type_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Style_Effect_Type type EINA_UNUSED)
{
   ASYNC_BLOCK;
...
_efl_canvas_text_efl_text_style_effect_type_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT_INFO(effect);
}

static void
_efl_canvas_text_efl_text_style_outline_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_style_outline_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
   _FMT_COLOR_RET(outline);
}

static void
_efl_canvas_text_efl_text_style_shadow_direction_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl_Text_Style_Shadow_Direction type EINA_UNUSED)
{
   ASYNC_BLOCK;
...
_efl_canvas_text_efl_text_style_shadow_direction_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT_INFO(shadow_direction);
}

static void
_efl_canvas_text_efl_text_style_shadow_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_style_shadow_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
   _FMT_COLOR_RET(shadow);
}

static void
_efl_canvas_text_efl_text_style_glow_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
   _FMT_COLOR_SET(glow);
}
...
static void
_efl_canvas_text_efl_text_style_glow_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
   _FMT_COLOR_RET(glow);
}

static void
_efl_canvas_text_efl_text_style_glow2_color_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char r EINA_UNUSED, unsigned char g EINA_UNUSED, unsigned char b EINA_UNUSED, unsigned char a EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static void
_efl_canvas_text_efl_text_style_glow2_color_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, unsigned char *r EINA_UNUSED, unsigned char *g EINA_UNUSED, unsigned char *b EINA_UNUSED, unsigned char *a EINA_UNUSED)
{
   _FMT_COLOR_RET(glow2);
}

static void
_efl_canvas_text_efl_text_style_gfx_filter_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED,
...
static const char *
_efl_canvas_text_efl_text_style_gfx_filter_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(gfx_filter)?_FMT(gfx_filter->name):NULL;
}

EOLIAN static void
_efl2_canvas_text_efl2_text_wrap_properties_ellipsis_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, double value EINA_UNUSED)
{
   ASYNC_BLOCK;
...
_efl2_canvas_text_efl2_text_wrap_properties_ellipsis_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(ellipsis);
}

EOLIAN static void
_efl2_canvas_text_efl2_text_wrap_properties_wrap_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Efl2_Text_Wrap_Mode wrap)
{
   ASYNC_BLOCK;
...
EOLIAN static Efl2_Text_Wrap_Mode
_efl2_canvas_text_efl2_text_wrap_properties_wrap_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT_INFO(wrap);
}

static void
_efl_canvas_text_efl_text_format_multiline_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Eina_Bool enabled EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static Eina_Bool
_efl_canvas_text_efl_text_format_multiline_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return o->multiline;
}
...
static void
_efl_canvas_text_efl_text_format_halign_set(Eo *obj, Efl2_Canvas_Text_Data *o,
      double value)
{
   ASYNC_BLOCK;
...
static double
_efl_canvas_text_efl_text_format_halign_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(halign);
}

static void
_efl_canvas_text_efl_text_format_valign_set(Eo *obj, Efl2_Canvas_Text_Data *o,
      double value)
{
   ASYNC_BLOCK;
...
static double
_efl_canvas_text_efl_text_format_valign_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return o->valign;
}

static void
_efl_canvas_text_efl_text_format_linegap_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, double value EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static double
_efl_canvas_text_efl_text_format_linegap_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(linegap);
}

static void
_efl_canvas_text_efl_text_format_linerelgap_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, double value EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static double
_efl_canvas_text_efl_text_format_linerelgap_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(linerelgap);
}

static void
_efl_canvas_text_efl_text_format_tabstops_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, int value EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static int
_efl_canvas_text_efl_text_format_tabstops_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(tabstops);
}

static void
_efl_canvas_text_efl_text_format_password_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, Eina_Bool enabled EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static Eina_Bool
_efl_canvas_text_efl_text_format_password_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return _FMT(password);
}

static void
_efl_canvas_text_efl_text_format_replacement_char_set(Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED, const char *repch EINA_UNUSED)
{
   ASYNC_BLOCK;
...
static const char *
_efl_canvas_text_efl_text_format_replacement_char_get(const Eo *obj EINA_UNUSED, Efl2_Canvas_Text_Data *o EINA_UNUSED)
{
   return o->repch;
}
...
#include "canvas/efl2_canvas_text.eo.c"
