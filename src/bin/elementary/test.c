...
void test_efl_ui_toolbar(void *data, Evas_Object *obj, void *event_info);
void test_efl_ui_toolbar_model(void *data, Evas_Object *obj, void *event_info);
...
#define ADD_TEST_EO(icon_, cat_, name_, cb_) _elm_test_add(&tests, icon_, cat_, name_, cb_, EINA_TRUE)
   ...
   ADD_TEST_EO(NULL, "Toolbars", "Efl.Ui.Toolbar", test_efl_ui_toolbar);
   ADD_TEST_EO(NULL, "Toolbars", "Efl.Ui.Toolbar Model", test_efl_ui_toolbar_model);
