 ...
 */
ELM_API void elm_calendar_first_day_of_week_set(Elm_Calendar *obj, Elm_Calendar_Weekday day);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API Elm_Calendar_Weekday elm_calendar_first_day_of_week_get(const Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_selectable_set(Elm_Calendar *obj, Elm_Calendar_Selectable selectable);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API Elm_Calendar_Selectable elm_calendar_selectable_get(const Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_interval_set(Elm_Calendar *obj, double interval);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API double elm_calendar_interval_get(const Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_weekdays_names_set(Elm_Calendar *obj, const char **weekdays);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API const char **elm_calendar_weekdays_names_get(const Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_select_mode_set(Elm_Calendar *obj, Elm_Calendar_Select_Mode mode);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API Elm_Calendar_Select_Mode elm_calendar_select_mode_get(const Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_format_function_set(Elm_Calendar *obj, Elm_Calendar_Format_Cb format_function);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API const Eina_List *elm_calendar_marks_get(const Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_date_min_set(Elm_Calendar *obj, const Efl_Time *min);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API const Efl_Time *elm_calendar_date_min_get(const Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_date_max_set(Elm_Calendar *obj, const Efl_Time *max);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API const Efl_Time *elm_calendar_date_max_get(const Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_selected_time_set(Elm_Calendar *obj, Efl_Time *selected_time);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API Eina_Bool elm_calendar_selected_time_get(const Elm_Calendar *obj, Efl_Time *selected_time);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API Elm_Calendar_Mark *elm_calendar_mark_add(Elm_Calendar *obj, const char *mark_type, Efl_Time *mark_time, Elm_Calendar_Mark_Repeat_Type repeat);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_marks_clear(Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API void elm_calendar_marks_draw(Elm_Calendar *obj);
 ...
 * @ingroup Elm_Calendar_Group
 */
ELM_API Eina_Bool elm_calendar_displayed_time_get(const Elm_Calendar *obj, Efl_Time *displayed_time);
