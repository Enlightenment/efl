...
Eina_Bool _canvas_text_cursor_prev(Efl2_Text_Cursor_Handle *cur, Eina_Bool per_cluster);
Eina_Bool _canvas_text_cursor_next(Efl2_Text_Cursor_Handle *cur, Eina_Bool per_cluster);
