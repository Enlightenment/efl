             ...
             if ((n = calloc(1, sizeof(Native))))
               {
                  ...
                  GL_TH_CALL(eglQueryWaylandBuffer, glsym_eglQueryWaylandBufferWL,
...
# define EGL_WAYLAND_BUFFER_WL 0x31D5
                  ...
                  if (GL_TH_CALL(eglQueryWaylandBuffer, glsym_eglQueryWaylandBufferWL,
                                 ob->egl_disp, wl_buf, EGL_WAYLAND_Y_INVERTED_WL, &yinvert) == EGL_FALSE)
                    yinvert = 1;
