#ifndef EFL_UI_TOOLBAR_PRIVATE_H
#define EFL_UI_TOOLBAR_PRIVATE_H

/* DO NOT USE THIS HEADER UNLESS YOU ARE PREPARED FOR BREAKING OF YOUR
 * CODE. THIS IS EFL_UI'S INTERNAL WIDGET API (for now) AND IS NOT
 * FINAL.
 */
 ...
 * @{
 *
 * @section efl-ui-toolbar-class The Efl Ui Toolbar Class
 *
 */
