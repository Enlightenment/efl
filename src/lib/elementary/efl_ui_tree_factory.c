                                                        ...
                                                        , Efl_Model *model, Efl_Gfx_Entity *parent)
{
   ...
   layout = efl_add(EFL_UI_LAYOUT_CLASS, parent,
                    ...
                    efl_ui_layout_theme_set(efl_added, pd->klass, pd->group, style));
...
EOLIAN static void
_efl_ui_tree_factory_efl_ui_layout_factory_theme_config(Eo *obj EINA_UNUSED, Efl_Ui_Tree_Factory_Data *pd
