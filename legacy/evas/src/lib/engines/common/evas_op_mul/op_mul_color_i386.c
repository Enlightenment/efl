...
init_mul_color_span_funcs_mmx(void)
{
   ...
   op_mul_span_funcs[SP_N][SM_N][SC][DP_AS][CPU_MMX] = _op_mul_c_dpas_mmx;
   op_mul_span_funcs[SP_N][SM_N][SC_AN][DP_AS][CPU_MMX] = _op_mul_can_dpas_mmx;
   op_mul_span_funcs[SP_N][SM_N][SC_AA][DP_AS][CPU_MMX] = _op_mul_caa_dpas_mmx;
}
#endif
...
#define _op_mul_pt_c_dpas_mmx _op_mul_pt_c_dp_mmx
#define _op_mul_pt_can_dpas_mmx _op_mul_pt_can_dp_mmx
#define _op_mul_pt_caa_dpas_mmx _op_mul_pt_caa_dp_mmx
...
init_mul_color_pt_funcs_mmx(void)
{
   ...
   op_mul_pt_funcs[SP_N][SM_N][SC][DP_AS][CPU_MMX] = _op_mul_pt_c_dpas_mmx;
   op_mul_pt_funcs[SP_N][SM_N][SC_AN][DP_AS][CPU_MMX] = _op_mul_pt_can_dpas_mmx;
   op_mul_pt_funcs[SP_N][SM_N][SC_AA][DP_AS][CPU_MMX] = _op_mul_pt_caa_dpas_mmx;
}
#endif
