...
Outbuf *
_orig_eng_window_new(Evas_Engine_Info_Wayland *einfo, int w, int h,
                     Render_Output_Swa swap_mode, int depth_bits,
                    int stencil_bits, int msaa_bits)
{
   Outbuf *gw;
   int context_attrs[3];
   int config_attrs[40];
...
>>>>>>> Evas GL - threaded rendering for gl_x11 and wayland_egl
