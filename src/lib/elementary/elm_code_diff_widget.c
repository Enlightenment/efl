...
elm_code_diff_widget_add(Evas_Object *parent, Elm_Code *code)
{
   ...
   widget_left = efl_add(ELM_CODE_WIDGET_CLASS, parent, elm_obj_code_widget_code_set(efl_self, wcode1));
   ...
   widget_right = efl_add(ELM_CODE_WIDGET_CLASS, parent, elm_obj_code_widget_code_set(efl_self, wcode2));
