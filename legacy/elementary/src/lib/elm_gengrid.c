...
static const char GENGRID_SMART_NAME[] = "elm_gengrid";
static const char GENGRID_PAN_SMART_NAME[] = "elm_gengrid_pan";
...
#define ELM_GENGRID_CHECK(obj)                                             \
  if (!obj || !elm_widget_type_check((obj), GENGRID_SMART_NAME, __func__)) \
    return
...
#define ELM_GENGRID_ITEM_CHECK_OR_GOTO(it, label)              \
  ...
  if (!it->base.widget || !elm_widget_type_check               \
        ((it->base.widget), GENGRID_SMART_NAME, __func__)) goto label;
...
EVAS_SMART_SUBCLASS_IFACE_NEW
  (GENGRID_SMART_NAME, _elm_gengrid, Elm_Layout_Smart_Class,
...
static void
_elm_gengrid_pan_smart_set_user(Elm_Pan_Smart_Class *sc)
{
...
static void
_elm_gengrid_smart_set_user(Elm_Layout_Smart_Class *sc)
{
