 ...
 * @ingroup Elm_Entry_Group
 */
EAPI Eina_Bool elm_entry_prediction_hint_hash_set(Elm_Entry *obj, const char *key, const char *value);
 ...
 * @ingroup Elm_Entry_Group
 */
EAPI Eina_Bool elm_entry_prediction_hint_hash_del(Elm_Entry *obj, const char *key);
