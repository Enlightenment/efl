                ...
                const void   *data)
{
   ...
   timer = eo_add(MY_CLASS, _ecore_parent, ecore_obj_timer_constructor(eo_self, in, func, data));
   return timer;
}
...
{
   Ecore_Timer *timer = NULL;
   timer = eo_add(MY_CLASS, _ecore_parent, ecore_obj_timer_loop_constructor(eo_self, in, func, data));
