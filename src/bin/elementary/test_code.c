...
_elm_code_test_welcome_setup(Evas_Object *parent)
{
   ...
   widget = efl_add(ELM_CODE_WIDGET_CLASS, parent, elm_obj_code_widget_code_set(efl_self, code));
...
_elm_code_test_diff_inline_setup(Evas_Object *parent)
{
   ...
   code = elm_code_create();
   diff = efl_add(ELM_CODE_WIDGET_CLASS, parent, elm_obj_code_widget_code_set(efl_self, code));
