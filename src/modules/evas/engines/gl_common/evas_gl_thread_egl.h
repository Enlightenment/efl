...
EVAS_TH_EGL_FN      (EGLBoolean , eglBindWaylandDisplay, EGLDisplay dpy, void *display) \
EVAS_TH_EGL_FN      (EGLBoolean , eglUnbindWaylandDisplay, EGLDisplay dpy, void *display) \
EVAS_TH_EGL_FN      (EGLBoolean , eglQueryWaylandBuffer, EGLDisplay dpy, void *buffer, EGLint attribute, EGLint *value) \
EVAS_TH_EGL_FN      (EvasGLSync , eglCreateSync, EGLDisplay dpy, EGLenum type, const EGLint *attrib_list) \
EVAS_TH_EGL_FN      (EGLBoolean , eglDestroySync, EGLDisplay dpy, EvasGLSync sync) \
EVAS_TH_EGL_FN      (EGLint     , eglClientWaitSync, EGLDisplay dpy, EvasGLSync sync, EGLint flags, EvasGLTime timeout) \
EVAS_TH_EGL_FN      (EGLBoolean , eglSignalSync, EGLDisplay dpy, EvasGLSync sync, EGLenum mode) \
EVAS_TH_EGL_FN      (EGLBoolean , eglGetSyncAttrib, EGLDisplay dpy, EvasGLSync sync, EGLint attribute, EGLint *value) \
EVAS_TH_EGL_FN      (EGLint     , eglWaitSync, EGLDisplay dpy, EvasGLSync sync, EGLint flags)
