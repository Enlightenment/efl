...
taken from the Boost.Context library through libostd and adapted to EFL's needs.
The files are licensed under the Boost Software License, version 1.0, unless
specified otherwise.
