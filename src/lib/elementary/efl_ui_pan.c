...
static void
_efl_ui_pan_update(Efl_Ui_Pan_Data *psd)
{
   efl_gfx_position_set(psd->content, EINA_POSITION2D(psd->x - psd->px, psd->y - psd->py));
}

EOLIAN static void
_efl_ui_pan_efl_canvas_group_group_add(Eo *obj, Efl_Ui_Pan_Data *psd EINA_UNUSED)
{
   efl_canvas_group_add(efl_super(obj, MY_CLASS));
}

EOLIAN static void
_efl_ui_pan_efl_canvas_group_group_del(Eo *obj, Efl_Ui_Pan_Data *_pd EINA_UNUSED)
{
...
EOLIAN static void
_efl_ui_pan_position_set(Eo *obj EINA_UNUSED, Efl_Ui_Pan_Data *psd, Eina_Position2D pos)
{
...
_efl_ui_pan_position_get(Eo *obj EINA_UNUSED, Efl_Ui_Pan_Data *psd)
{
   return EINA_POSITION2D(psd->px, psd->py);
}

EOLIAN static Eina_Position2D
_efl_ui_pan_position_max_get(Eo *obj EINA_UNUSED, Efl_Ui_Pan_Data *psd)
{
...
EOLIAN static Eina_Position2D
_efl_ui_pan_position_min_get(Eo *obj EINA_UNUSED, Efl_Ui_Pan_Data *_pd EINA_UNUSED)
{
...
_efl_ui_pan_efl_container_content_set(Evas_Object *obj, Efl_Ui_Pan_Data *psd, Evas_Object *content)
{
   Eina_Size2D sz;
...
#define EFL_UI_PAN_EXTRA_OPS \
   EFL_CANVAS_GROUP_ADD_DEL_OPS(efl_ui_pan)
