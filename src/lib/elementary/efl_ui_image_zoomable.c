...
EOLIAN static void
_efl_ui_image_zoomable_pan_efl_ui_pan_position_set(Eo *obj, Efl_Ui_Image_Zoomable_Pan_Data *psd, Eina_Position2D pos)
{
...
_efl_ui_image_zoomable_pan_efl_ui_pan_position_get(Eo *obj EINA_UNUSED, Efl_Ui_Image_Zoomable_Pan_Data *psd)
{
   return EINA_POSITION2D(psd->wsd->pan_x, psd->wsd->pan_y);
}

EOLIAN static Eina_Position2D
_efl_ui_image_zoomable_pan_efl_ui_pan_position_max_get(Eo *obj, Efl_Ui_Image_Zoomable_Pan_Data *psd)
{
   Evas_Coord ow, oh;
...
EOLIAN static Eina_Position2D
_efl_ui_image_zoomable_pan_efl_ui_pan_position_min_get(Eo *obj EINA_UNUSED, Efl_Ui_Image_Zoomable_Pan_Data *_pd EINA_UNUSED)
{
...
_bounce_eval(void *data, const Efl_Event *event EINA_UNUSED)
{
 ...
 on_end:
   ...
   efl_ui_scrollable_freeze_set(sd->smanager, EINA_FALSE);
...
_efl_ui_image_zoomable_efl_canvas_group_group_add(Eo *obj, Efl_Ui_Image_Zoomable_Data *priv)
{
   ...
   efl_ui_scroll_manager_mirrored_set(priv->smanager, efl_ui_mirrored_get(obj));
   ...
   evas_object_raise(edje_object_part_object_get(edje, "elm.dragable.hbar"));
   evas_object_raise(edje_object_part_object_get(edje, "elm.dragable.vbar"));
...
EOLIAN static Eina_Bool
_efl_ui_image_zoomable_efl_canvas_layout_signal_signal_callback_add(Eo *obj EINA_UNUSED, Efl_Ui_Image_Zoomable_Data *sd EINA_UNUSED, const char *emission, const char *source, Edje_Signal_Cb func_cb, void *data)
{
   Eina_Bool ok;
   ELM_WIDGET_DATA_GET_OR_RETURN(obj, wd, EINA_FALSE);
...
EOLIAN static Eina_Bool
_efl_ui_image_zoomable_efl_canvas_layout_signal_signal_callback_del(Eo *obj EINA_UNUSED, Efl_Ui_Image_Zoomable_Data *sd EINA_UNUSED, const char *emission, const char *source, Edje_Signal_Cb func_cb, void *data)
{
   Eina_Bool ok;
   ELM_WIDGET_DATA_GET_OR_RETURN(obj, wd, EINA_FALSE);
...
_efl_ui_image_zoomable_image_region_set(Eo *obj, Efl_Ui_Image_Zoomable_Data *sd, Eina_Rect region)
{
   ...
   efl_ui_scrollable_show(sd->smanager, EINA_RECT(rx, ry, rw, rh));
}

EOLIAN static void
_efl_ui_image_zoomable_efl_ui_scrollable_interactive_scroll(Eo *obj, Efl_Ui_Image_Zoomable_Data *sd, Eina_Rect rc)
{
   int rx, ry, rw, rh;
   ...
   efl_ui_scrollable_scroll(sd->smanager, EINA_RECT(rx, ry, rw, rh));
}
                                   ...
                                   int h EINA_UNUSED)
{
   ...
   EFL_UI_IMAGE_ZOOMABLE_DATA_GET(obj, sd);
   efl_ui_scrollable_scroll(sd->smanager, EINA_RECT(x, y, w, h));
}
