...
static int _cursor_text_insert(Efl_Text_Cursor_Cursor *cur, const char *_text);
...
static int
_cursor_text_insert(Efl_Text_Cursor_Cursor *cur, const char *_text)
{
   int len;
