        ...
        if (edje_info && edje_info->insert)
          {
             ...
             efl_access_object_event_emit(EFL_ACCESS_OBJECT_CLASS, data, EFL_ACCESS_TEXT_EVENT_ACCESS_TEXT_INSERTED, &atspi_info);
          }
        else if (edje_info && !edje_info->insert)
          {
             ...
             efl_access_object_event_emit(EFL_ACCESS_OBJECT_CLASS, data, EFL_ACCESS_TEXT_EVENT_ACCESS_TEXT_REMOVED, &atspi_info);
          }
     }
}
        ...
        if (edje_info && edje_info->insert)
          {
             ...
             atspi_info.pos = edje_info->change.insert.pos;
             atspi_info.len = edje_info->change.insert.plain_length;
             efl_access_object_event_emit(EFL_ACCESS_OBJECT_CLASS,
                                                       data,
...
//   if (!_entry_win_is_wl(data))
   ...
   if (_elm_config->atspi_mode)
     efl_access_object_event_emit(EFL_ACCESS_OBJECT_CLASS, data, EFL_ACCESS_TEXT_EVENT_ACCESS_TEXT_SELECTION_CHANGED, NULL);
}
                                ...
                                const char *source EINA_UNUSED)
{
   ...
   if (_elm_config->atspi_mode)
     efl_access_object_event_emit(EFL_ACCESS_OBJECT_CLASS, data, EFL_ACCESS_TEXT_EVENT_ACCESS_TEXT_CARET_MOVED, NULL);
}
