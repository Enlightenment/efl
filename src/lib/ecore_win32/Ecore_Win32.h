...
ECORE_WIN32_API void ecore_win32_window_activate(Ecore_Win32_Window *window);
...
ECORE_WIN32_API void ecore_win32_window_borderless_set(Ecore_Win32_Window *window,
                                            Eina_Bool           on);
ECORE_WIN32_API void ecore_win32_window_maximized_set(Ecore_Win32_Window *window,
                                           Eina_Bool           on);
